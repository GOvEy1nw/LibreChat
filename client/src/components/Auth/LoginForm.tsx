...
const LoginForm: React.FC<TLoginFormProps> = ({ onSubmit, startupConfig, error, setError }) => {
  ...
  return (
    <>
      {showResendLink && (
        <div className="mt-2 rounded-md border border-sky-500 bg-sky-500/10 px-3 py-2 text-sm text-gray-600 dark:text-gray-200">
      ...
      >
        ...
        {startupConfig.passwordResetEnabled && (
          <a href="/forgot-password" className="text-sm text-sky-500">
