...
function ResetPassword() {
  ...
  if (resetPassword.isSuccess) {
    return (
      <>
        <div
          className="relative mb-8 mt-4 rounded border border-sky-400 bg-sky-100 px-4 py-3 text-center text-sky-700 dark:bg-gray-900 dark:text-white"
          role="alert"
        >
        ...
        <button
          ...
          className="w-full transform rounded-md bg-sky-500 px-4 py-3 tracking-wide text-white transition-colors duration-200 hover:bg-sky-600 focus:bg-sky-600 focus:outline-none"
        >
    ...
    >
      ...
      <div className="mt-6">
        <button
          ...
          className="w-full transform rounded-md bg-sky-500 px-4 py-3 tracking-wide text-white transition-all duration-300 hover:bg-sky-550 focus:bg-sky-550 focus:outline-none"
        >
          {localize('com_auth_continue')}
        </button>
      </div>
